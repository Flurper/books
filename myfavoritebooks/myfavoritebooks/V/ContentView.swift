...
struct BookRow: View {
    ...
    var body: some View {
        NavigationLink(
            ...
            HStack {
                Book.Image(
                    image: library.images[book], title: book.title, size: 80, cornerRadius: 12)
                VStack(alignment: .leading) {
                    BookView(book: book, titleFont: .title2, authorFont: .title3)
                    ...
                    BookRow(book: book)
                        .swipeActions(edge: .leading) {
                            Button {
                                ...
                                book.myFavoriteBook ? Label("finished", systemImage: "boommark.slash")
                                : Label("reading list", systemImage: "boommark")
                            }
                            .tint(.accentColor)
                        }
